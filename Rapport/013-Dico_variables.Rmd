...
Afin d'avoir une base opérationnelle pour la partie statistiques descriptives et machine learning, nous avons enfin nettoyé les données : nous avons supprimé les variables pour lesquelles la part de données manquante était trop importante, imputé les valeurs manquantes par la moyenne pour les autres, et remplacé les distances "infinies" (causée par une valeur nulle d'un indicateur pour une commune) par le maximum observé sur les autres lignes.
