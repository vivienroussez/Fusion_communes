...
#On voit que la variance intra-classes stagne ? partir de 5 classes.
#On voit qu'avec les 5 classes, pr?s de 90% de la variance totale sur l'ensemble des variables une 
